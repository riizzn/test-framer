  ...
  return (
    <section className="max-w-7xl mx-auto px-6 sm:px-10 py-20 bg-white light-grad overflow-x-clip">
      ...
      <div className="relative">
        <Image src={glass1} alt="glass" width={360} className="hidden  md:block md:absolute -top-90 -left-50"/>
        <Image src={glass2} alt="glass" width={360} className="absolute md:block md:absolute -top-90 -right-50"/>
      </div>
    </section>
  );
};
